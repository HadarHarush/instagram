<template>
  <div class="nav-bubble-content nav-bubble-profile-content flex column">
    <div class="regular-content-box">
      <a
        class="regular-content-item content-item flex align-center avoid-hover-effect"
      >
        <svg
          aria-label="Profile"
          class="_8-yf5 "
    ...
    <div class="special-content-box">
      <a
        class="special-content-item content-item flex align-center avoid-hover-effect"
        @click="logout"
      >
        <p>Log out</p>
      </a>
